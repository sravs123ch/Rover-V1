...
const gramgold1Image = require("../assets/1gramgold_Images/r1.webp");
const gramgold2Image = require("../assets/1gramgold_Images/r2.webp");
const gramgold3Image = require("../assets/1gramgold_Images/r3.webp");
const gramgold4Image = require("../assets/1gramgold_Images/r4.webp");
const gramgold5Image = require("../assets/1gramgold_Images/r5.webp");
const gramgold6Image = require("../assets/1gramgold_Images/r6.webp");
const gramgold7Image = require("../assets/1gramgold_Images/r1.webp");
  ...
  return (
    <div className="container mx-auto p-10 mt-10 flex flex-col lg:flex-row justify-center max-w-screen-2xl">
      <div className="w-full lg:w-4/5">
        <h1 className="text-4xl font-extrabold text-center text-orange-400 mt-12 mb-4">Our Best 1 gram Gold Items</h1>
