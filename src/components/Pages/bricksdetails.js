...
const BricksDetailsPage = () => {
  ...
  const product = {
    ...
    price: '₹0.50',
    offer: '5% off',
    description: 'High-quality red bricks ideal for all construction needs. Durable and reliable.',
    specifications: {
      weight: '3 kg per brick',
      color: 'Red',
    ...
    rating: 4.2,
    reviews: [
      { id: 1, name: 'Alice Brown', review: 'Excellent quality bricks!', rating: 5 },
      { id: 2, name: 'David Lee', review: 'Good bricks but slightly brittle.', rating: 4 },
    ],
    relatedProducts: [
      { id: 2, name: 'Brick Type B', image: ClayBrick, price: '₹0.50' },
      { id: 3, name: 'Brick Type C', image: ConcreteBrick, price: '₹0.70' },
    ],
  };
...
export default BricksDetailsPage;
